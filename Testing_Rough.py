...
#    m1,m2=bo.review_Decider(round_bracket_check=x,square_bracket_check=y,single_quotes_check=w,double_quotes_check=t,asterisk_check=z,single_slash_start_check=q)
...
# print(df)
# # pip
# df['Properties'].replace('',np.nan,inplace=True)
# nan_value=float("Nan")
